...
export function DriverLayout({ children }: DriverLayoutProps) {
  ...
  const routes = [
    ...
    },
    {
      ...
      label: "Payments",
      icon: CreditCard,
      active: pathname === "/driver/payments",
    },
    {
    ...
    },
    {
      ...
      label: "Safety",
      icon: Shield,
      active: pathname === "/driver/safety",
    },
    {
      href: "/driver/settings",
      label: "Settings",
      icon: Settings,
      active: pathname === "/driver/settings",
    },
  ]
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/driver/dashboard" className="font-bold">
              RideChain
            </Link>
            <Badge className="ml-2 bg-indigo-600">Driver</Badge>
          </div>
